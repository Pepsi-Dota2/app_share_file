...
part of 'user_login_usecase.dart';
...
class _$LoginParamsImpl implements _LoginParams {
  const _$LoginParamsImpl({this.username = "", this.password = ""});
...
abstract class _LoginParams implements LoginParams {
  const factory _LoginParams({final String username, final String password}) =
      _$LoginParamsImpl;
